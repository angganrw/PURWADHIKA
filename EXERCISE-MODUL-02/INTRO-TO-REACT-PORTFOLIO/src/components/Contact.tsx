...
const Contact: React.FC = () => {
  return (
    <section
      id="contact"
      className="h-screen py-20 bg-[#414142] flex flex-col items-center justify-center"
    >
      <h2 className="text-4xl font-bold text-[#ffdd79] mb-40">⚙️ Contact /</h2>
      <div className="flex flex-col md:flex-row w-full max-w-6xl mx-auto p-6 bg-[#414142] rounded-lg shadow-2xl">
        <div className="w-full md:w-1/3 p-4">
          ...
          <div className="flex items-center mb-4 text-white">
            ...
            <div>
              ...
              <p className="text-gray-300">me@angganrw.id</p>
            </div>
          </div>
          <div className="flex items-center mb-4 text-white">
            <div className="bg-blue-500 p-3 rounded-full mr-3">
